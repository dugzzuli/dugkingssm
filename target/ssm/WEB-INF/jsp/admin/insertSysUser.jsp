    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="<%=basePath%>admin/insertSysUser" method="post" id="myform" name="myform" >
                    <table class="insert-tab" width="100%">
                            ...
                            <tr>
                                ...
                                <td><input class="common-text required" name="userPwd" size="50" type="text"></td>
                            </tr>
                             <tr>
                                <th><i class="require-red">*</i>级别：</th>
                                <td><input class="common-text required" name="sys" size="50" type="text"></td>
                            </tr>
