		...
		<div class="main-wrap">
			...
			<div class="result-wrap">
				<div class="result-content">
					<form action="<%=basePath%>admin/update" method="post" id="myform"
						name="myform">
							...
							<tbody>
								<tr>
									...
									<td><select name="category" id="catid" class="required">
											...
											<c:forEach var="catemodels" items="${list}">
												<option value="${catemodels.cateId}">${catemodels.cateName}</option>
											</c:forEach>

									</select></td>
								</tr>
								<tr>
									<th><input type="hidden" name="id" value="${model.id }" /><i
										class="require-red">*</i>标题：</th>
									<td><input class="common-text required" id="newsTitle"
										name="newsTitle" size="50" value="${model.newsTitle }"
										type="text"></td>
								</tr>
								<tr>
									<th>作者：</th>
									<td><input class="common-text" name="author" size="50"
										value="${model.author }" type="text"></td>
								</tr>
								<tr>
									<th>SEO描述：</th>
									<td><input class="common-text" name="seoDesc" size="50"
										value="${model.seoDesc }" type="text"></td>
								</tr>
								<tr>
									<th>SEO内容：</th>
									<td><input class="common-text" name="seoContent" size="50"
										value=" ${model.seoContent}" type="text"></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input name="summary" id="summary"
										value="${model.summary }" type="text"></td>
								</tr>
								<tr>
									<th>内容：</th>
